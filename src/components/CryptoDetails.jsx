...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails?.volumn && millify(cryptoDetails?.volumn)}`, icon: <ThunderboltOutlined /> },
  ...
  return (
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        <Title level="2">{cryptoDetails.name} ({cryptoDetails.name.toLowerCase()}-{cryptoDetails.symbol.toLowerCase()})</Title>
      ...
      <Col className="coin-desc-link">
        ...
        <Col className="coin-links">
          <Title level={4} className="coin-details-heading">{cryptoDetails.name} Links</Title>
